...
KAIPU_ROOT = HERE / ".." / ".." / "ros2" / "kaipu_model"
DROID_X2_ROOT = HERE / ".." / ".." / "ros2" / "droid_mod" / "droid_x2_22dof"
PIPER_ROOT = HERE / ".." / ".." / "ros2" / "agx_arm_urdf" / "piper" / "urdf"
...
ROBOT_XML_DICT = {
    ...
    "kaipu": KAIPU_ROOT / "1230-URDF-version-fixed_mode_pos.xml",
    "droid_x2": DROID_X2_ROOT / "x2_g.xml",
    "piper": PIPER_ROOT / "piper_mujoco.urdf",
}
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "kaipu": IK_CONFIG_ROOT / "smplx_to_kaipu.json",
        "droid_x2": IK_CONFIG_ROOT / "smplx_to_droid_x2.json",
        "piper": IK_CONFIG_ROOT / "smplx_to_piper.json",
    },
    "bvh_lafan1":{
